...
**1. Human Message:** Represents input from a user.<br>
**2. System Message:** Used to provide instructions or context to the model.<br>
**3. Function Message:** Represents the result of a function call<br>
**4. AI Message:** Represents responses generated by AI models<br>
**5. Tool Message:** Similar to Function Message, but specific to tool usage<br>
